...
public class USSDService extends AccessibilityService {
    ...
    public void onAccessibilityEvent(AccessibilityEvent event) {
        ...
        switch (strOut) {
            case "07":
                if(text.matches("(?i).*crédit:.*")){

                    String crdt = text.substring(text.indexOf(":") + 1, text.indexOf("DA"));

                    editor.putString(BALANCE, crdt.replaceAll(" ", ""));
                    editor.apply();
                }
                break;
            ...
            default:
                Toast.makeText(this, "Probléme lors de la lecture du crédit.", Toast.LENGTH_SHORT).show();
                break;
